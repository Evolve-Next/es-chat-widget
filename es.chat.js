...
class ESChat {
  ...
  styleSetup() {
    ...
    link.setAttribute('rel', 'stylesheet');
    link.setAttribute('type', 'text/css');
    link.setAttribute('href', '/es.chat.min.css');
    this.head.appendChild(link);
  }
  formContainer() {
  ...
  formButtonVectorPath() {
    ...
    this.chatButtonSvgPathEl.setAttributeNS(null, 'fill', this.config.primary.main);
  }
  ...
  formChatBoxHeader() {
    ...
    this.chatBoxHeaderEl.style.backgroundColor = this.config.primary.dark;
  ...
  formChatBoxHeaderDP() {
    ...
    this.chatBoxHeaderDPEl.src = this.DpSrc;
    ...
    this.chatBoxHeaderDPStatusEl.style.backgroundColor = this.config.status.online;
  }
  ...
  formChatBoxHeaderContent() {
    ...
    this.chatBoxHeaderNameEl.innerHTML = 'EasySocial';
    this.chatBoxHeaderDescEl.innerHTML = 'Typically Replies Instantly';
  }
  ...
  formChatBoxBody() {
    ...
    this.chatBoxBodyEl.style.backgroundColor = this.config.body.bg;
    this.chatBoxCloudSenderEl.innerHTML = 'EasySocial';
    this.chatBoxCloudMessageEl.innerHTML = 'Hi there<br />How can i help you?';
    this.chatBoxCloudTimeEl.innerHTML = '5:20 PM';
  ...
  formChatBoxFooter() {
    ...
    this.chatBoxFooterEl.style.backgroundColor = this.config.footer.bg;
    ...
    this.chatBoxFooterButtonIconPathEl.setAttributeNS(null, 'fill', '#ffffff');
    this.chatBoxFooterButtonLabelEl.innerHTML = 'Start Chat';
    this.chatBoxFooterPoweredEl.innerHTML = 'POWERED BY <a href="https://easysocial.io" target="_blank">EASYSOCIAL.IO</a>';
  ...
  render() {
    this.chatButtonEl.addEventListener('click', this.onChatButtonClick);
